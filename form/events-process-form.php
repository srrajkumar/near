...
require 'phpmailer/PHPMailerAutoload.php';
 ...
 $mail = new PHPMailer;
	...
	$mail->isHTML(true); 
	$mail->setFrom('events@adnear.net');     //Set who the message is to be sent from
							...
							<table width='100%' border='0' cellpadding='0' cellspacing='0'>
							  <tbody>
							    <tr>
							      ...
							      <td> <p style='margin: 15px 15px 0px 0;'>Events Enquiry</p>
													...
													<table border='0' cellpadding='0' cellspacing='0' width='100%'>
														...
														<tr>
															<td style='line-height: 40px;'>
																<b style='color:rgba(0, 0, 0, 0.64);'>Interested Event : </b> $file
															</td>
