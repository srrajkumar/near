        ...
        <div id="bootstrap-touch-slider" class="carousel bs-slider fade carousel-fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
          ...
          <div class="carousel-inner" role="listbox">
              <div class="item active">
                <!-- Slide Background -->
                <img src="<?php IMAGE('allspark/allspark-omni-channel.png'); ?>" alt="Allspark Omni-channel "/>
              </div>
    ...
    <ul class="list-group sidebar-nav-v1" id="sidebar-nav">
		...
		<li class="list-group-item list-toggle active">
			...
			<ul class="list-group sidebar-nav-v1" id="sidebar-nav">
				...
				<li class="list-group-item list-toggle">
					<a href="<?php echo SITE_URL; ?>allspark/omni-channel-customer-experience.php" class="active" target="_self">Omni-Channel Experience</a>
				</li>
			</ul>
		</li>
		<li class="list-group-item list-toggle"><a href="#"></a></li>
