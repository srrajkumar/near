                              ...
                              <div class="col-md-6 col-md-offset-3 ofx-auto">
                                 <div class="login-form ol-tab">
                                        ...
                                        <div id="register" class="tab-pane active">
                                             ...
                                             <form action="<?php echo SITE_URL; ?>form/research-process-form.php" method="post" enctype="multipart/form-data" onSubmit="return validate();" role="form" id="research-form" name="research-form">
                                           ...
                                           <div class="login-copyright">For customized research, please reach us at <a href="mailto:insights@near.co" target="_blank">insights@near.co</a></div>
                                       </div>
                                    </div>
                                 </div>
