...
<div class="cd-testimonials-wrapper cd-container container">
	<ul class="cd-testimonials ">
		...
		<li>
			<div class="col-md-4"><img src="<?php IMAGE('testimonial/david-sandler.png'); ?>" alt="" /></div>
			<div class="col-md-6">
...
<p class="cd-author-info">David Sandler<br>	Head of Media Products at Fetch, United Kingdom  <p>
		...
		<li>
			<div class="col-md-4"><img src="<?php IMAGE('testimonial/ryuji-yokoyama.png'); ?>" alt="" /></div>
			<div class="col-md-6">
...
<p class="cd-author-info">Ryuji Yokoyama<br>President & CEO, Digital Intelligence Inc<p>
		...
		<li>
			<div class="col-md-4"><img src="<?php IMAGE('testimonial/vishnu-mohan.png'); ?>" alt="" /></div>
			<div class="col-md-6">
...
The interface is extremely simple to use and declutters complex data sets with ease, which can be actioned by brands in real-time.</p>
				...
				<div class="cd-author">
					<img src="<?php IMAGE('testimonial/vishnu-mohan.png'); ?>" alt="" />
					<ul class="cd-author-info">
						<li>Vishnu Mohan</li>
					<li>CEO Asia Pacific,</li>
					<li> Havas Media Group </li>
					</ul>
				</div> <!-- cd-author -->
			</li>
			...
			<li class="cd-testimonials-item">
				...
				<div class="cd-author">
					...
					<ul class="cd-author-info">
						...
						<li>MCN Digital Partnerships and</li>
...
like no other interface. It is a very intuitive product, and has already provided significant value to our clients.</p>
				...
				<div class="cd-author">
					<img src="<?php IMAGE('testimonial/david-sandler.png'); ?>" alt="" />
					<ul class="cd-author-info">
						<li>David Sandler</li>
						<li>Head of Media Products at Fetch, </li>
			...
			<li class="cd-testimonials-item">
				<p>I expect Allspark, the first location audience platform in the Japan market,to make more breakthroughs in brand marketing activities utilizing data.</p>
				
				<div class="cd-author">
					<img src="<?php IMAGE('testimonial/ryuji-yokoyama.png'); ?>" alt="" />
					<ul class="cd-author-info">
						<li>Ryuji Yokoyama</li>
						<li>President & CEO,</li>
						<li>Digital Intelligence Inc</li>
					</ul>
				</div> <!-- cd-author -->
			</li>
