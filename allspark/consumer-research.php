        ...
        <div id="bootstrap-touch-slider" class="carousel bs-slider fade carousel-fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
          ...
          <div class="carousel-inner" role="listbox">
              <div class="item active">
                <!-- Slide Background -->
                <img src="<?php IMAGE('allspark/allspark-consumer-research.png'); ?>" alt="Allspark Consumer Research"/>
              </div>
    ...
    <ul class="list-group sidebar-nav-v1" id="sidebar-nav">
		...
		<li class="list-group-item list-toggle active">
			...
			<ul class="list-group sidebar-nav-v1" id="sidebar-nav">
				...
				<li class="list-group-item list-toggle">
					<a href="<?php echo SITE_URL; ?>allspark/consumer-research.php" target="_self" class="active">Consumer research</a>
				</li>
				<li class="list-group-item list-toggle">
