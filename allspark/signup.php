...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800%7CRoboto:100,300,400,500,700,900" rel="stylesheet">
	...
	<link rel="shortcut icon" href="<?php IMAGE('favicon.ico'); ?>">

 <style type="text/css">
    .navbar-brand .near-logo{fill:#ffffff !important;}
    .navbar-brand .a-logo{fill:#e9262d !important;}
    .navbar .nav ul li a, .banner-content span:nth-child(6){color: #fff;}
...
<div class="preloader"></div>
	...
	<!-- product section -->
    <section id="home" class="product parallax">
    	<div class="parallax-banner-1 parallax-background hide-on-mobile"></div><!-- parallax bg -->
    	<div class="grid-container" style="z-index:999;">
    		<div id="contact" class="grid-100 mobile-grid-100 tablet-grid-100">
                <h1><div class="svg-allspark" style="width: 250px; height: 73px; display: inline-block; position: relative; top: 5px;">
...
<g class="st1">
	<path class="st0" d="M40.9,39.7v-6.6c0-0.2,0.1-0.4,0.2-0.5c0.1-0.1,0.3-0.2,0.5-0.2h2c1,0,1.7,0.2,2.2,0.6s0.8,1,0.8,1.8
		s-0.3,1.4-0.8,1.9s-1.3,0.6-2.3,0.6h-1.4v2.3c0,0.4-0.2,0.6-0.5,0.6h-0.2C41.1,40.2,40.9,40.1,40.9,39.7z M42.1,36.4h1.4
		c1.2,0,1.8-0.5,1.8-1.5s-0.6-1.5-1.8-1.5h-1.4V36.4z"/>
	<path class="st0" d="M47.6,39.7v-5.2c0,0,0,0,0.1-0.1s0.1,0,0.2-0.1s0.1,0,0.2,0c0.5,0,0.7,0.3,0.7,1c0.3-0.7,0.7-1.1,1.5-1.1
		c0.3,0,0.5,0.1,0.7,0.2s0.3,0.3,0.3,0.5c0,0.1,0,0.3-0.1,0.4c-0.1,0.1-0.1,0.2-0.2,0.2c-0.1,0-0.1,0.1-0.1,0
		c-0.2-0.2-0.5-0.3-0.7-0.3c-0.9,0-1.3,0.8-1.3,2.3v2c0,0.4-0.2,0.6-0.5,0.6h-0.1C47.8,40.2,47.6,40.1,47.6,39.7z"/>
	<path class="st0" d="M51.7,37.3c0-0.9,0.3-1.6,0.8-2.2s1.3-0.9,2.1-0.9s1.5,0.3,2,0.8s0.8,1.2,0.8,2.1v0.1c0,0.1,0,0.2-0.1,0.3
		s-0.1,0.1-0.3,0.1h-4.3c0,0.5,0.2,1,0.6,1.3c0.4,0.3,0.8,0.5,1.4,0.5c0.8,0,1.4-0.3,1.8-1c0,0,0.1,0,0.2,0c0.1,0,0.2,0.1,0.3,0.2
		s0.2,0.2,0.2,0.4c0,0.3-0.2,0.6-0.7,0.9s-1.1,0.4-1.8,0.4c-0.9,0-1.6-0.3-2.2-0.8S51.7,38.2,51.7,37.3z M52.8,36.8h3.5
		c0-0.5-0.2-0.9-0.5-1.2s-0.7-0.4-1.2-0.4s-0.9,0.2-1.2,0.5S52.9,36.3,52.8,36.8z"/>
	<path class="st0" d="M58.6,39.7v-5.2c0,0,0,0,0.1-0.1s0.1,0,0.2-0.1s0.1,0,0.2,0c0.5,0,0.7,0.3,0.7,0.9c0.4-0.7,1-1,1.8-1
		c0.9,0,1.6,0.4,1.9,1.2c0.5-0.8,1.1-1.2,2-1.2c0.7,0,1.3,0.2,1.6,0.6c0.4,0.4,0.5,1,0.5,1.8v3c0,0.4-0.2,0.6-0.5,0.6H67
		c-0.4,0-0.5-0.2-0.5-0.6v-2.9c0-1-0.4-1.5-1.3-1.5c-0.3,0-0.6,0.1-0.8,0.3c-0.3,0.2-0.5,0.4-0.6,0.7v3.4c0,0.4-0.2,0.6-0.5,0.6H63
		c-0.4,0-0.5-0.2-0.5-0.6v-2.8c0-1-0.4-1.5-1.3-1.5c-0.3,0-0.6,0.1-0.8,0.3c-0.3,0.2-0.5,0.4-0.6,0.7v3.4c0,0.4-0.2,0.6-0.5,0.6
		h-0.1C58.7,40.2,58.6,40.1,58.6,39.7z"/>
	<path class="st0" d="M68.9,32.5c0-0.4,0.2-0.7,0.7-0.7s0.7,0.2,0.7,0.7c0,0.4-0.2,0.7-0.7,0.7c-0.2,0-0.4-0.1-0.5-0.2
		S68.9,32.7,68.9,32.5z M69,39.7V35c0-0.4,0.2-0.6,0.5-0.6h0.1c0.4,0,0.5,0.2,0.5,0.6v4.7c0,0.4-0.2,0.6-0.5,0.6h-0.1
		C69.2,40.2,69,40.1,69,39.7z"/>
	<path class="st0" d="M71.7,37.9V35c0-0.4,0.2-0.6,0.5-0.6h0.1c0.4,0,0.5,0.2,0.5,0.6v2.8c0,0.5,0.1,0.9,0.4,1.2
		c0.2,0.3,0.6,0.4,1,0.4c0.7,0,1.2-0.3,1.6-1v-3.3c0-0.4,0.2-0.6,0.5-0.6h0.1c0.4,0,0.5,0.2,0.5,0.6v5.2c0,0,0,0-0.1,0.1
		c0,0-0.1,0-0.2,0.1s-0.1,0-0.2,0c-0.5,0-0.7-0.3-0.8-0.9c-0.5,0.7-1.1,1-1.9,1c-0.7,0-1.3-0.2-1.7-0.7S71.7,38.6,71.7,37.9z"/>
	<path class="st0" d="M78.5,39.7v-5.2c0,0,0,0,0.1-0.1s0.1,0,0.2-0.1s0.1,0,0.2,0c0.5,0,0.7,0.3,0.7,0.9c0.4-0.7,1-1,1.8-1
		c0.9,0,1.6,0.4,1.9,1.2c0.5-0.8,1.1-1.2,2-1.2c0.7,0,1.3,0.2,1.6,0.6c0.4,0.4,0.5,1,0.5,1.8v3c0,0.4-0.2,0.6-0.5,0.6h-0.1
		c-0.4,0-0.5-0.2-0.5-0.6v-2.9c0-1-0.4-1.5-1.3-1.5c-0.3,0-0.6,0.1-0.8,0.3c-0.3,0.2-0.5,0.4-0.6,0.7v3.4c0,0.4-0.2,0.6-0.5,0.6
		h-0.1c-0.4,0-0.5-0.2-0.5-0.6v-2.8c0-1-0.4-1.5-1.3-1.5c-0.3,0-0.6,0.1-0.8,0.3c-0.3,0.2-0.5,0.4-0.6,0.7v3.4
		c0,0.4-0.2,0.6-0.5,0.6H79C78.6,40.2,78.5,40.1,78.5,39.7z"/>
</g>
<g>
	...
	<path class="st2" d="M175.8,7.6L175.8,7.6c0-2.5,1.5-4.4,3.7-4.4s3.7,1.9,3.7,4.3l0,0c0,2.4-1.5,4.3-3.7,4.3
		...
		S181.4,9.1,181.4,7.6z"/>
                ...
                <input name="name" class="grid-45" type="text" id="name" value="" placeholder="Full Name" />
                <input name="email" class="grid-45" type="text" id="email" value="" placeholder="Business Email"/>
                <input name="phone" class="grid-45" type="text" id="phone" value="" placeholder="Contact Number" />
                <input name="country" class="grid-45" type="text" id="country" value="" placeholder="Country" />
                <input name="company" class="grid-45" type="text" id="company" value="" placeholder="Company Name" />
                <input name="find" class="grid-45" type="text" id="find" value="" placeholder="How did you find us" />
                <div class="clear"></div>
                <input type="checkbox" name="verify" value="" id="verify" /> <span style="color:#F4F4F4">I agree with <a href="<?php echo SITE_URL; ?>terms/" style="color:#FFFFFF; text-decoration:underline;">Terms and conditions</a></span><div class="clear"></div>
                <input type="submit" class="submit" id="submit" value="Submit" style="float:none; margin:10px auto" >
                
                
                </form>
            </div>													
    	</div>
    </section><!-- close product section -->
    <div class="clear"></div>
    <!-- information section -->
