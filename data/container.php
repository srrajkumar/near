...
<div class="container top-spacer data-container" style="padding: 100px 0">
          ...
          <a href="<?php echo SITE_URL; ?>contact/#data" class="button button--primary button--rounded" style="margin-left: 0;">Partner with us</a>
                ...
                <div class="icon-set-3 col-md-12 margin-padding row fivecolumn" style="margin-top: 20px;">
                  ...
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-2.png') ?>" />
                    <hr />
                    <p>Transaction</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-3.png') ?>" />
                    <hr />
                    <p>Location</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-4.png') ?>" />
                    <hr />
                    <p>Weather</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-5.png') ?>" />
                    <hr />
                    <p>Traffic</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-6.png') ?>" />
                    <hr />
                    <p>Real Estate</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-7.png') ?>" />
                    <hr />
                    <p>Credit Score</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-8.png') ?>" />
                    <hr />
                    <p>WiFi</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-9.png') ?>" />
                    <hr />
                    <p>Content</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-3/icon-10.png') ?>" />
                    <hr />
                    <p>Retail</p>
                  </div>
                </div>
        ...
        <div class="container top-spacer data-container" style="padding: 100px 0">
        <div class="row" style="margin: 0; justify-content: space-between;">
                <div class="col col-md-3 data-section-left">
          ...
          <a href="<?php echo SITE_URL; ?>contact/#data" class="button button--primary button--rounded" style="margin-left: 0;">Get in Touch</a>
                ...
                <div class="icon-set-3 col-md-12 margin-padding row fivecolumn" style="margin-top: 20px;">
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-4/icon-1.png') ?>" />
                    <hr />
                    <p>Brands</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-4/icon-2.png') ?>" />
                    <hr />
                    <p>Hedge funds</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-4/icon-3.png') ?>" />
                    <hr />
                    <p>Governments</p>
                  </div>
                  <div class="sections">
                    <img src="<?php IMAGE('data/icon-set-4/icon-4.png') ?>" />
                    <hr />
                    <p>Research firms</p>
                  </div>
    ...
    <div class="container" style="padding:30px 0; text-align: center; "><a href="<?php echo SITE_URL; ?>privacy" class="button red button--primary button--rounded" style="margin-left: 0;">Privacy Policy</a></div>
    </div>
