<div class="col-md-3 sidebar page-transition">
								...
								<ul class="recent">
                        	        <li><a href="<?#php echo SITE_URL; ?>news/meet-aditi-kohli-our-new-general-manager-for-south-east-asia-and-hong-kong.php">Meet Aditi Kohli, our new General Manager for South East Asia and Hong Kong</a></li>
                         	        <li><a href="<?#php echo SITE_URL; ?>news/how-ambient-intelligence-is-changing-how-business-is-done.php">How Ambient Intelligence Is Changing How Business Is Done</a></li>
								...
								<ul class="tags-list">
									...
									<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/campaignbriefasia.php">Campaign Breif Asia</a></li>
