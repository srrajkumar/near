...
<head>
	...
	<meta property="og:image" content="http://near.co/images/news/Near-moves-into-SEA-targets-it-as-key-growth-region-in-APAC.png" />
</head>
	<body>
	...
	<?php include('../includes/_navigation.php'); ?>
        ...
        <p>Near, a location-aware mobile advertising platform, has just announced today that it will be entering its services in Southeast Asia soon, starting with Singapore, Malaysia and Indonesia....</p>
        
        <p>It originally completed the move of its global headquarter from India to Singapore and are expecting to house more than a dozen staff members by the end of this year. The Singapore office will oversee regional operations, sales, marketing and product development while its India operators will focus on research and development efforts, and continue to serve the local customer and partner base.</p>
        <p>Near provides a location-aware technology platform for advertisers enabling precision targeting of consumers on their mobile devices. By aggregating user information, points of interest, trends and behavioural patterns and marrying them to contextual ad formats, Near helps brands connect with their audiences with relevant information.</p>
        ...
        <p>Near will be participating at ad:tech 2013 (booth 21) in Singapore from 13 to 14 June 2013.</p>
		<p>Source : <a href="http://e27.co/adnear-moves-into-sea-targets-it-as-key-growth-region-in-apac/" target="_blank">e27</a>
