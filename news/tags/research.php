				...
				<div class="content small-top-padding colors-e background-90-e blog">
					<div class="container">
							...
							<div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											...
											<p><a href="<?php echo SITE_URL; ?>news/australia-students-research.php" class="page-transition btn-sm">Read more...</a></p>
								...
								<div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											...
											<p><a href="<?php echo SITE_URL; ?>news/qsrs-or-coffee-chains-near-latest-research-reveals-consumer-trends-seen-across-south-east-asia.php" class="page-transition btn-sm">Read more...</a></p>
											<div class="post-tags styled-list">
												<i class="fa fa-tags"></i>
												<ul>
												<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/research.php">Research</a></li>
								...
								<div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											...
											<p><a href="<?php echo SITE_URL; ?>news/singapore-sales-research-consumer-insights.php" class="page-transition btn-sm">Read more...</a></p>
											<div class="post-tags styled-list">
												<i class="fa fa-tags"></i>
												<ul>
													<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/research.php">Research</a></li>
                      ...
                      <p>There was a significant rise in the number of shoppers during the weekend of Valentine’s in Hong Kong, Indonesia – Jakarta and Singapore</p>
											<p><a href="<?php echo SITE_URL; ?>news/valentine-weekend-saw-18-percent-heavy-footfall-on-an-average-in-top-shopping-destinations-across-south-east-asia.php" class="btn-sm page-transition">Read more...</a></p>
											<div class="post-tags styled-list">
												<i class="fa fa-tags"></i>
												<ul>
													<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/research.php">Research</a></li>
								 ...
								 <div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											...
											<p><a href="<?php echo SITE_URL; ?>news/affluent-travel-the-most-to-attend-sports-events-in-australia.php" class="btn-sm page-transition">Read more...</a></p>
											<div class="post-tags styled-list">
												<i class="fa fa-tags"></i>
												<ul>
													<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/research.php">Research</a></li>
								...
								<div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											...
											<p><a href="<?php echo SITE_URL; ?>news/mobile-activity-surges-hong-kong-adnear-location-intelligence-study.php" class="btn-sm page-transition">Read more...</a></p>
											<div class="post-tags styled-list">
												<i class="fa fa-tags"></i>
												<ul>
													<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/research.php">Research</a></li>
								...
								<div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											...
											<p><a href="<?php echo SITE_URL; ?>news/adnear-japac-traveller-study-shows-hong-kong-australian-affluent-most-engaged-on-mobile.php" class="btn-sm page-transition">Read more...</a></p>
											<div class="post-tags styled-list">
												<i class="fa fa-tags"></i>
												<ul>
													<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/research.php">Research</a></li>
