				...
				<div class="content small-top-padding colors-e background-90-e blog">
					<div class="container">
                      ...
                      The Fortune Global 500 list is back again, and the US still leads the tally with 128 companies in the list: <a href="http://fortune.com/global500/wal-mart-stores-1/" target="_blank">Fortune 500, 2014</a>...</p>
											<p><a href="../fortune-100-list-for-2014-trust-adnear-to-reach-out.php" class="button2 button2--primary button2--rounded">Read more</a>
											<div class="post-tags styled-list">
												<i class="fa fa-tags"></i>
												<ul>
													<li><a class="page-transition" href="<?php echo SITE_URL; ?>news/tags/techinasia.php">Tech In Asia</a></li>
				    ...
				    <p>The time people  spent shopping in Chinatown increased 26 per cent compared to regular weekends,  whilst the time spent in Marina Bay Sands and on Orchard Rd reduced by 20 per  cent.</p>          
								 ...
								 <div class="row post">
									...
									<div class="post-date">
										...
										<div class="post-month">Jul 2013</div></div>
