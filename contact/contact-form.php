...
<body>
 ...
 <form class="custom-form" action="<?php echo SITE_URL; ?>form/process-form.php" method="post" onSubmit="document.getElementById('career-form-submit-loader').style.display='inline';">
