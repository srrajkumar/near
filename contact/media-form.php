...
<body>
 ...
 <form data-enable-shim="true" class="custom-form" action="<?php echo SITE_URL; ?>form/media-process-form.php" method="post" onSubmit="document.getElementById('career-form-submit-loader').style.display='inline';">
        ...
        <div class="form-group margin-bottom col-md-12 row">
          ...
          <div class="col-md-6 row">
             <select id="contact-reason" class="form-control" name="contact_reason" required >            
