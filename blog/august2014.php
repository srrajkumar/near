									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<a class="page-transition" href="<?php echo SITE_URL; ?>blogs/our-startup-culture-helps-us-succeed.php"><img class="fluid-width" src="<?php IMAGE('blog/Our-startup-culture-helps-us-succeed.png'); ?>" alt="Another Post with Imag"></a>
											</div>
											<h4 style="text-align:left;"><a class="page-transition" href="<?php echo SITE_URL; ?>blogs/our-startup-culture-helps-us-succeed.php">Our startup culture helps us succeed.</a></h4>
											<p>
											...
											<p><a href="<?php echo SITE_URL; ?>blogs/our-startup-culture-helps-us-succeed.php" class="btn-sm page-transition">Read more...</a></p>
