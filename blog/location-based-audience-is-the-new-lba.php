<?php include("../includes/_config.php"); include("../includes/_lib.php"); $meta_title = 'Location Based Audience is the new LBA | Profile Mobile Users | Near';
...
<html class="background-100-e">
    ...
    <meta name="KEYWORDS" content="Geodata/ Geo data, Insights, Location insights, Mobile marketing, Location based marketing, Location based advertising, Location data, Location based mobile marketing" />
    ...
    <meta property="og:image" content="http://near.co/images/bimg.jpg" />
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<img class="fluid-width" src="<?php IMAGE('blog/Location-Based-Audience-is-the-new-LBA.png'); ?>" alt="">
											</div>
											<h4 style="text-align:left;"><?php echo $title; ?></h4>
											<p>It was a tall order when we decided to have our own location platform that can get geo-location of users without the need of GPS or operator assistance. To cover 4000 cities and towns for the most granular location coverage in APAC. To beat the 95% location detection mark across feature phones and smartphones. To be the largest location-based advertising company in the region. That was 2009.</p>

<p>Early 2013, after more than 2 billion location foot prints across thousands of cities, we were facing a different  challenge.</p>

<p>Location-based Advertising had been around for a while now. It worked well in some scenarios but also failed to reach the scale in other scenarios. There’s no disagreement that location is one of the most powerful piece in targeting a user for advertisement. But the scale and effectiveness only comes by putting location into right use. </p>

<p>Welcome to Location Based Audience™; LBA 2.0</p>

<p>With months of super-complex engineering effort AdNear created a scalable way to profile mobile users accurately. The core of this offering remains location with a combination of behavior and context.  This meant building an intelligent system that uses real-world data and combining it with virtual data to profile users like never before.  The audience profile that’s built using location as the core component.</p>


<p><a href="#"><img src="<?php IMAGE('blog/intelligence.jpg'); ?>" width="561" height="194" alt=""></a></p><br>

<p>There was no way we could have achieved this without the enormous amount of data that we had collated over our lifespan. Today we at AdNear are proud to own Location Based Audience; the new LBA, thanks to our cool engineering team. I and my team are extremely passionate about this offering and if you need to know more please feel free to reach out to me or my colleagues.</p>
