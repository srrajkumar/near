									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<img class="fluid-width" src="<?php IMAGE('blog/all-i-want-for-christmas-is-retail-analytics.png'); ?>" alt="">
											</div>
...
<p>Despite concerns over the sluggish economy, retailers remain hopeful; gearing up to attract shoppers, tourists and locals to spend the big bucks.</p>
...
<h4 style="font-size:18px; text-align:left; margin-bottom: 0px;">What does the data say?</h4>
...
<h4 style="text-align:left; font-size:18px; margin-bottom: 0px;">The Great Singapore Shift?</h4>
...
<p>With the online shopping scene heating up, should there be a new metric to determine the success of Singapore’s retail scene?.</p>


<p>Retailers must act quickly if they are looking to capitalise on the current shopping trends. If wages and income remain steady, consumers will begin to frequent brick-and-mortar locations soon. Even though shoppers will continue to research pricing advantages using mobile and digital platforms, the actual purchases will be done in-store more often during the upcoming season.</p>
...
<h4 style="text-align:left; font-size:18px; margin-bottom: 0px;">Strategy, strategy, strategy</h4>
...
<h4 style="text-align:left; font-size:18px; margin-bottom: 0px;">Watch this (retail) space</h4>
...
<p>Also published in  <a href="https://insideretail.sg/2016/12/07/all-i-want-for-christmas-is-retail-analytics/" target="_blank"> Inside Retail</a>.</p>
