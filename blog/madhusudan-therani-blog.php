...
<html class="background-100-e">
    ...
    <title>Near Blog | Madhusudan Therani</title>
...
<!--META TAG-->
    ...
    <meta name="AUTHOR" content="Madhusudan Therani" />
						...
						<div class="row">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<a class="page-transition" href="<?php echo SITE_URL; ?>blogs/near-platform-introduces-placematrix-enhances-spatial-precision.php"><img class="fluid-width" src="<?php IMAGE('blog/near-platform-introduces-placematrix-enhances-spatial-precision.jpg'); ?>" alt=""></a>
											</div>
											<h4 style="text-align:left;"><a class="page-transition" href="<?php echo SITE_URL; ?>blogs/near-platform-introduces-placematrix-enhances-spatial-precision.php">Near platform introduces PlaceMatrix, enhances spatial precision</a></h4>
											...
											<p><a href="<?php echo SITE_URL; ?>blogs/near-platform-introduces-placematrix-enhances-spatial-precision.php"  class="page-transition btn-sm">Read more...</a></p>
                            ...
                            <div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<a class="page-transition" href="<?php echo SITE_URL; ?>blogs/understanding-the-three-location-data-conundrums.php"><img class="fluid-width" src="<?php IMAGE('blog/understanding-the-three-location-data-conundrums.jpg'); ?>" alt=""></a>
											</div>
											<h4 style="text-align:left;"><a class="page-transition" href="<?php echo SITE_URL; ?>blogs/understanding-the-three-location-data-conundrums.php">Understanding the 3 Location Data conundrums</a></h4>
											<p>
											...
											<p><a href="<?php echo SITE_URL; ?>blogs/understanding-the-three-location-data-conundrums.php" class="page-transition btn-sm">Read more...</a></p>
