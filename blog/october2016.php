									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<a class="page-transition" href="<?php echo SITE_URL; ?>blogs/over-1-billion-devices-and-counting.php"><img class="fluid-width" src="<?php IMAGE('blog/over-1-billion-devices-and-counting.png'); ?>" alt=""></a>
											</div>
											<h4 style="text-align:left;"><a class="page-transition" href="<?php echo SITE_URL; ?>blogs/over-1-billion-devices-and-counting.php">Over 1 billion devices, and counting</a></h4>
											...
											<p><a href="<?php echo SITE_URL; ?>blogs/over-1-billion-devices-and-counting.php"  class="page-transition btn-sm">Read more...</a></p>
