                            ...
                            <div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<a class="page-transition" href="<?php echo SITE_URL; ?>blogs/5-tips-apac-marketers-should-consider-in-data-driven-targeting.php"><img class="fluid-width" src="<?php IMAGE('blog/5-tips-apac-marketers-should-consider-in-data-driven-targeting.png'); ?>" alt=""></a>
											</div>
											<h4 style="text-align:left;"><a class="page-transition" href="<?php echo SITE_URL; ?>blogs/5-tips-apac-marketers-should-consider-in-data-driven-targeting.php">5 Tips APAC Marketers Should Consider in Data-Driven Targeting</a></h4>
											
											<p>Media planning has become a bigger challenge as marketers and agencies become more sophisticated with their data use...</p>
											<p><a href="<?php echo SITE_URL; ?>blogs/5-tips-apac-marketers-should-consider-in-data-driven-targeting.php"  class="button2 button2--primary button2--rounded">Read more</a></p>
                              ...
                              <div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<a class="page-transition" href="<?php echo SITE_URL; ?>blogs/how-the-qsr-industry-can-leverage-mobile-data-in-apac.php"><img class="fluid-width" src="<?php IMAGE('blog/how-the-qsr-industry-can-leverage-mobile-data-in-apac.png'); ?>" alt=""></a>
											</div>
											<h4 style="text-align:left;"><a class="page-transition" href="<?php echo SITE_URL; ?>blogs/how-the-qsr-industry-can-leverage-mobile-data-in-apac.php">How the QSR industry can leverage mobile data in APAC</a></h4>
											...
											<p><a href="<?php echo SITE_URL; ?>blogs/how-the-qsr-industry-can-leverage-mobile-data-in-apac.php"  class="button2 button2--primary button2--rounded">Read more</a></p>
								 ...
								 <div class="row post">
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<a class="page-transition" href="<?php echo SITE_URL; ?>blogs/experimenting-with-drones-for-data-collection.php"><img class="fluid-width" src="<?php IMAGE('blog/pic1.jpg'); ?>" alt=""></a>
											</div>
											<h4 style="text-align:left;"><a class="page-transition" href="<?php echo SITE_URL; ?>blogs/experimenting-with-drones-for-data-collection.php">Experimenting With Drones For Data Collection</a></h4>
											<p>
											...
											<p><a href="<?php echo SITE_URL; ?>blogs/experimenting-with-drones-for-data-collection.php" class="button2 button2--primary button2--rounded">Read more</a></p>
