<?php include("../includes/_config.php"); include("../includes/_lib.php"); $meta_title = 'Geo-location Data | Consumer Insights | Attribution';
...
<html class="background-100-e">
    ...
    <meta property="og:image" content="http://www.near.co/images/blog/Think.png" />
									...
									<div class="col-md-9">
										<div class="post-body background-75-e">
											<div class="post-image">
												<img class="fluid-width" src="<?php IMAGE('blog/Think.png'); ?>" alt="">
											</div>
											<h4 style="text-align:left;"><?php echo $title; ?></h4>
											<p>Being able to identify a consumer’s location to deliver relevant and contextualised ads in real time represents a game changer for advertisers, and research by mobileSQUARED has revealed that <a href="http://mobilesquared.co.uk/media/27790/Geolocation-in-Mobile-Advertising_White-Paper_2011.pdf" target="_blank">70-80%</a> of brands active in mobile are keen to utilise geo-location targeting. </p>

<p>However, a lack of understanding about the technology is hindering marketers from taking full advantage of its capabilities – and even deterring some from implementing geo-targeting campaigns completely.  </p>

<p>A common misconception is that GPS is the only way to effectively track the location of devices, but this isn’t always the case. Technology available today can target consumers using mobile towers and Wi-Fi signals, and this capability becomes invaluable when you consider that GPS is turned off 70% of the time. </p>

<p>Another myth is that geo-location data is only beneficial in the retail sector. But while it is certainly effective for targeting consumers within the immediate proximity of a store, it can also be used to build brand awareness with relevant audiences much further afield. </p>
...
<h4 style="text-align:left;">Objectives first </h4>
...
<h4 style="text-align:left;">Context and audience</h4>
...
<h4 style="text-align:left;">The Snapchat generation</h4>
...
<h4 style="text-align:left;">Attributing the consumer journey</h4>
...
<p>Location technology benefits from offering marketers the means for online and offline attribution. From location footprints that are mapped to device identifiers, brands can measure ROI on digital and Out of Home spend and understand whether a purchase has come as a result of an in-app mobile advert. Knowing whether a consumer has been exposed to a supermarket ad on their mobile device or via a billboard allows marketers to map activity and see whether the consumer later visited the promoted supermarket, and attribute the path to conversion.</p>

<p>Mobile data can also provide marketers with unique insights into the behaviour of consumers in physical stores. If a customer uses their mobile device in-store to comparison shop, read product reviews or search for coupons, marketers are empowered with the knowledge of why a consumer made a purchase or left empty-handed. </p>
<p>Geo-location is a vital marketing tool for brands. By exploiting the technology’s full capabilities, marketers will never need to make assumptions based on where they think their target audience is – they will have the insight to know the answer.</p>
<p>Published in <a href="https://www.exchangewire.com/blog/2015/09/14/how-can-marketers-take-geo-location-further/" target="_blank"> ExchangeWire</a>.</p>
