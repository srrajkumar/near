          ...
          <h1 class="custom-title"><span>Upcoming</span> Events</h1>
            ...
            <ul style="list-style:none; cursor:pointer; padding-left:0px;">
             ...
             <div class="mix apac europe japan event-month-set ">June</div>
                      ...
                      <div class="mix japan event-container map-open" data-map-overlay=".map-overlay" onclick="loginForm(); SetPage('<?php echo SITE_URL; ?>events/form.php?link=Cannes Lions');" >
                  ...
                  <div class="mix europe event-container map-open" data-map-overlay=".map-overlay" onclick="loginForm(); SetPage('<?php echo SITE_URL; ?>events/form.php?link=Cannes Lions');">
                  ...
                  <div class="mix apac event-container map-open" data-map-overlay=".map-overlay" onclick="loginForm();; SetPage('<?php echo SITE_URL; ?>events/form.php?link=MRMW Asia-Pacific 2017');">
                    <div class="image-box"><a class="link-event" href="http://apac.mrmw.net/" target="_blank"><p><img src="<?php IMAGE('events/mrmw-apac.png'); ?>" width="80" height="80" alt=""/></p></a></div>
                      ...
                      <div class="mix apac event-container map-open" data-map-overlay=".map-overlay" onclick="loginForm(); SetPage('<?php echo SITE_URL; ?>events/form.php?link=CMO Summit');">
