          ...
          <h1 class="custom-title"><span>Upcoming</span> Events</h1>
            ...
            <ul style="list-style:none; cursor:pointer; padding-left:0px;">
             ...
             <div class="mix apac europe japan event-month-set ">June</div>
                      ...
                      <div class="mix japan event-container map-open button" data-map-overlay=".map-overlay" onclick="SetPage('<?php echo SITE_URL; ?>events/form.php?link=Cannes Lions');" >
                  ...
                  <div class="mix europe event-container map-open button" data-map-overlay=".map-overlay" onclick=" SetPage('<?php echo SITE_URL; ?>events/form.php?link=Cannes Lions');">
...
<div class="modal-bg">
<div id="modal">
  <span>Events Form<a href="#close" id="close">&#215;</a></span>
  <iframe src="#" id="myframe" frameborder="0" scrolling="no" style="overflow:hidden;" height="100%" width="100%"></iframe>
  </div></div>
